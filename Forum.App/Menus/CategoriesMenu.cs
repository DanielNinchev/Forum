namespace Forum.App.Menus
{
    ...
    public class CategoriesMenu : Menu, IPaginatedMenu
	{
		...
		public override IMenu ExecuteCommand()
		{
			...
			//Actual index is calculated by multiplying the current page by the number of categories shown per page
			//and adding the current index of this page
			int actualIndex = this.currentPage * 10 + this.currentIndex;

			//If the current index is between 0 and 10, we are on a category
		...
		//Changes pages, resets the index and reloads the new page categories;
